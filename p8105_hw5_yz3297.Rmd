...
####The dataset has `r ncol(homicide_data)` variables and `r ncol(homicide_data)` observations. The main variables are id, date, victim first name, last name, race and age.
